      ...
      <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
        ...
        <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4 ">
          <div className=" w-full lg:w-8/12 bg-gray-100 flex justify-center items-center  object-cover ">
            <img
              src="https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5,q_80/cae50e62-cb2e-401b-b13e-6a925de46afb/air-jordan-1-hi-flyease-mens-shoes-VjGcGX.png"
          ...
          <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6  object-cover">
            <div className="scale-100 hover:scale-[2] ease-in duration-200 bg-gray-100 flex justify-center items-center py-4 ">
              <img
                src="https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5,q_80/71ee1bff-f2d0-49ad-882e-8de4b61fcce5/air-jordan-1-hi-flyease-mens-shoes-VjGcGX.png"
            ...
            <div className="scale-100 hover:scale-[2] ease-in duration-200 bg-gray-100 flex justify-center items-center py-4object-cover">
              <img
                src="https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5,q_80/98c110aa-f4cc-43b3-85de-6e93b4bce292/air-jordan-1-hi-flyease-mens-shoes-VjGcGX.png"
            ...
            <div className="scale-100 hover:scale-[2] ease-in duration-200 bg-gray-100 flex justify-center items-center py-4  object-cover">
              <img
                src="https://static.nike.com/a/images/t_PDP_864_v1/f_auto,b_rgb:f5f5f5/24a54f95-8a68-49e5-a1f1-54c21ae58778/air-jordan-1-hi-flyease-mens-shoes-VjGcGX.png"
        ...
        <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
          <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">Jordan 1 High OG</h2>
          ...
          <p className=" font-normal text-base leading-6 text-gray-600 mt-7">
            Бүрхүүлтэй Агаарын зөөлөвчөөс эхлээд оосор дээрх товойлгон Wings лого хүртэл AJ1-д дуртай бүх зүйл FlyEase технологитой уялдаа холбоотой.
          </p>
          ...
          <div className="lg:mt-11 mt-10">
            ...
            <div className=" flex flex-col  justify-between items-center mt-4">
              ...
              <div className=" flex items-center justify-center hover:bg-black hover:text-white  border-[1px] border-solid border-black w-8 h-8">41</div>
            </div>
