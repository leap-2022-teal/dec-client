    ...
    <div className={isMenuDropDownOpen ? subCategoryActive : subCategoryInActive}>
      <div className={isSearchActive ? outDivActive : outDivInActive}>
        ...
        <div className={`${isSideMenuActive ? sideMenuOutDivActive : `` && isSearchActive ? outDivActive : ` flex justify-between w-[90%]`}`}>
          ...
          <div className={`${isSearchActive ? searchActive : searchInactive && isSideMenuActive ? `flex-col justify-center p-3` : searchInactive}`} ref={dropdownRef}>
            <div className={`${isSideMenuActive ? ` ` : `flex-row gap-7 flex justify-center`}`}>
              {menu
                ...
                .map((category: any) => (
                  <Link href={""}>
                    ...
                    <div className="flex items-center justify-between">
                      <div
                        className={`${category._id === isMenuDropDownOpen ? categoryActive : categoryInActive && isSideMenuActive ? sideMenuCategoryActive : categoryInActive}`}
          ...
          <div className={isSearchActive ? inputOutDivActive : inputOutDivInActive && isMenuDropDownOpen ? `mobile:flex mobile:gap-4 mt-4` : inputOutDivInActive}>
            ...
            {/* bag icon */}
            <div className={isSearchActive ? bagIconActive : bagIconInActive && isSideMenuActive ? `hidden` : bagIconInActive}>
              <svg aria-hidden="true" className="pre-nav-design-icon" focusable="false" viewBox="0 0 24 24" role="img" width="24px" height="24px" fill="none">
                <path
                  stroke="currentColor"
                  stroke-width="1.5"
            ...
            {/* sidemenu icon */}
            <div className={isSearchActive ? menuIconActive : menuIconInActive && isSideMenuActive ? `hidden` : `tablet:block mobile:block between:block laptop:hidden desktop:hidden`}>
